$(document).ready(function () {
    ...
    test("isEqual", function () {
        ...
        // Chaining.
        ok(!_.isEqual(_({x: 1, y: undefined}).chain(), _({
            x: 1,
            z: 2
